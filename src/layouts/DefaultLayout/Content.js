                ...
                <div className={cx('info')}>
                    ...
                    <ul className={cx('info-list')}>
                        ...
                        <li>
                            ...
                            <p className={cx('title-name')}>
                                <a href="https://github.com/KieuTung007">
                                    https://github.com/KieuTung007
                                </a>
                            </p>
                        </li>
                    </ul>
            ...
            <div className={cx('experience')}>
                ...
                <div>
                    ...
                    <span className={cx('context')}>
                        ...
                        <ul>
                            <li>
                                Thiết kế , xây dựng, bảo trì các hệ thống tự
                                động hóa trong các nhà máy sản xuất bao bì
                                carton, bao bì , nước giải khát, bánh kẹo ....
                            </li>
                            <li>
                                Cải tiến cá hệ thống cũ nhằm nâng cao năng suất
                                .
                            </li>
                        </ul>
                    </span>
                ...
                <div>
                    ...
                    <span className={cx('context')}>
                        ...
                        <ul>
                            <li>
                                Thiết kế và kiểm tra lỗi cho các loại mạch nguồn
                                như : mạch sạc điện thoại, mạch công suất lưu
                                điện, .....
                            </li>
                        </ul>
                    </span>
            ...
            <div className={cx('projects')}>
                ...
                <div className={cx('project-item')}>
                    ...
                    <span className={cx('description')}>
                        <h4>Descriptions :</h4>
                        <p>
                            Xây dựng trang web bán hàng của trà sữa Phúc Long
                            Làm lại web trà Phúc Long về giao diện người dùng
                            trên web, có chức năng đăng nhập, tìm kiếm loại trà
                            , chia các bố cục...
                        </p>
                    </span>
                    ...
                    <span className={cx('link')}>
                        <h4>Link web demo :</h4>
                        <a href="https://phuclong-ui.vercel.app/">
                            https://phuclong-ui.vercel.app/
                        </a>
                    </span>
                    <span className={cx('link')}>
                ...
                <div className={cx('project-item')}>
                    ...
                    <span className={cx('description')}>
                        <h4>Descriptions :</h4>
                        <p>
                            Làm lại trang web của zingmp3 , về phần giao diện
                            người dùng, chức năng phát , dừng, chuyển bài , load
                            bài hát từ link API của Backend
                        </p>
                    </span>
                    <span className={cx('link')}>
                        <h4>Link Github :</h4>
                    ...
                    <span className={cx('link')}>
                        <h4>Technology in use :</h4>
                        <p>
                            - Frontend: ReactJS, Redux, axios, Reponsive,
                            Css(scss)
                        </p>
                    </span>
                </div>
